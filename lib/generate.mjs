...
<header class="site-header"><div class="header-inner"><a class="brand" data-page-link="home" href="${prefix}"><span class="brand-mark" aria-hidden="true">◫</span><span class="brand-title"><span id="country-name">${escapeHtml(country.name)}</span><small>Territorial information &amp; planning</small></span></a><nav class="primary-nav" aria-label="Main pages">${links}</nav></div></header>
