...
<header class="site-header"><div class="header-inner"><div class="header-top"><a class="brand" data-brand-link href="${prefix}" title="Return to the AreaData start"><span class="brand-mark" aria-hidden="true">◫</span><span class="brand-title"><span>AreaData</span><small id="dataset-name">${escapeHtml(country.name)} · data, diagnosis &amp; planning</small></span></a><div class="language-switcher" role="group" aria-label="Language" data-i18n-skip><button type="button" data-language="en" aria-label="English" aria-pressed="false">EN</button><button type="button" data-language="es" aria-label="Spanish" aria-pressed="false">ES</button><button type="button" data-language="ja" aria-label="Japanese" aria-pressed="false">日本語</button></div></div><nav class="primary-nav" aria-label="Main pages">${links}</nav></div></header>
