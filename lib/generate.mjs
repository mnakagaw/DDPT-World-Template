...
<header class="site-header"><div class="header-inner"><a class="brand" data-brand-link href="${prefix}" title="Return to the AreaData start"><span class="brand-mark" aria-hidden="true">◫</span><span class="brand-title"><span>AreaData</span><small id="dataset-name">${escapeHtml(country.name)} · data, diagnosis &amp; planning</small></span></a><nav class="primary-nav" aria-label="Main pages">${links}</nav></div></header>
...
<footer class="site-footer">AreaData · Source-reported and calculated values are labelled separately · Missing data remain explicit</footer>
</body></html>
`;
}
...
export async function generateSite({dataset, outDir}) {
  ...
  for(const file of ['app.mjs','model.mjs','analysis.mjs','aggregation.mjs','diagnostic.mjs','planning.mjs','planning-view.mjs','styles.css']) {
