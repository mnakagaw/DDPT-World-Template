...
export function renderInternalComparison(data,parentId,indicatorId,period,{interactive=true,language='en',suppressEmpty=false,printGeometryRegistry=null}={}) {
