...
function metricCard(indicator) {
  ...
  return `<article class="indicator-card"><div class="indicator-heading"><h3>${e(indicator.name)}</h3><span class="unit">${e(meaning.unit)}</span></div>${partial?`<p class="partial-label">${e(partialLabel)}</p>`:''}${overallValue}${populationContext(indicator,result)}
  ${percentVisual}
