...
**Status: partial domestic candidate; independent country-edition verdict REJECT; unpublished.** Local ignored candidate: `generated/georgia-areadata-20260926`; separately bootstrapped/re-fetched replay: `generated/georgia-replay-20260926`. The [tracked official-source audit](../../evidence/georgia-geostat-2024-kutaisi-planning-2026-09-26.md), [63-column register](../../evidence/georgia-geostat-2024-numeric-columns-2026-09-26.csv) and [independent audit and repair record](../../evidence/georgia-independent-audit-2026-09-26.md) record originals, field decisions, hashes, the thematic P1 repair, Kutaisi evidence and limitations. The candidates retain raw files, receipts, source rows, seven-area output checks and producer notes outside Git.
...
Producer commit `dee7bbd45b8535293a2d2e65589ace928e9ff847` and independently accepted thematic P1 repair `eda8c7c353ce5ab4684564e1b91b88dfc0f50e4c` are pushed; the repair was integrated as `354af8b`. The repair acceptance does not change the country verdict. The 18 official source locations were returned to Kit without values; exact AreaData bundle and Kit import commits, SHA-256 and stage controls are in [the roundtrip handoff](KIT_FEEDBACK_HANDOFF.md).

Next: complete the remaining source, geography, planning and applicable acceptance work, then submit a fixed dataset/commit to an independent checker. Substantive unfinished work remains: all other 2024 census topical/agricultural tables, official 2024 codes/geometry, current Kutaisi budget revisions, other local plans/budgets/implementation/evaluation, narrow screen/print checks and applicable acceptance scenarios. No country hosting/publication before independent country-edition `ACCEPT`.
