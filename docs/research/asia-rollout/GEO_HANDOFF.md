...
Only code, source leads, evidence and status are saved to GitHub. Kit feedback and both repository commits will be recorded in `KIT_FEEDBACK_HANDOFF.md`; all leads must remain at `official_location_identified` until Kit independently audits them.
