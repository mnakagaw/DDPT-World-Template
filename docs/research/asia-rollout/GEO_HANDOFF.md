...
Producer commit `dee7bbd45b8535293a2d2e65589ace928e9ff847` is pushed and fixed for independent review. The 18 official source locations were returned to Kit without values; exact AreaData bundle and Kit import commits, SHA-256 and stage controls are in [the roundtrip handoff](KIT_FEEDBACK_HANDOFF.md).
