...
Kit feedback is **source-location-only** (`official_location_identified`) until Kit independently audits each lead. It does not transfer original files, observations or country acceptance. Local: partial candidate. GitHub: scoped code, audit and source leads to be pushed. Hosting: none. Public: none.
