...
**Partial domestic candidate; independent country-edition verdict REJECT; unpublished.** Local ignored candidate: `generated/azerbaijan-areadata-20260926`; fresh bootstrap/replay: `generated/azerbaijan-replay-20260926`. The [source and output audit](../../evidence/azerbaijan-ssc-2026-age-astara-planning-2026-09-26.md), [727-column register](../../evidence/azerbaijan-ssc-xls-numeric-columns-2026-09-26.csv) and [independent audit](../../evidence/azerbaijan-independent-audit-2026-09-26.md) explain adopted and pending evidence. Original 11 files, acquisition receipts, source row checks and actual ten-area outputs remain in each ignored project; large or redistribution-unreviewed originals are not in Git.
...
The independent checker audited fixed producer commit `e150eb27ee907f7b816911ad4ccea9b5cbaf1009` and dataset SHA-256 `009c2a6e13a06a39f9d997818ea989f7582aaaa7b1b9a81c99381d9ac9ed324d`. The verdict was **REJECT** for country completion, with no new P0/P1 implementation regression in the checked source, replay, ten outputs and browser paths. Source-feedback bundle commit `0ce513e38e071399f3e2b3a332b7bbb4f41f6a19` and Kit import commit `7bcdd5a99f8999829856190a083ca8af626eb544` were pushed and remote heads verified; see [feedback handoff](KIT_FEEDBACK_HANDOFF.md).

Next: audit the 2019 census A/B volumes and all 704 unadopted XLS numeric columns; reconcile every official code and current dated polygon including territorial changes; establish legal planning roles and plan annex/current revisions; acquire other local plans, budgets, execution and evaluations; finish representative/narrow/print/download and applicable acceptance scenarios; seek a new independent audit on a fixed revised candidate. No country publication before independent `ACCEPT`.
