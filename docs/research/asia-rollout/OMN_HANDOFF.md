...
**Status: 2020 eCensus population and housing-unit subsets plus one national 2026–2030 plan document; partial, not independently accepted or published.** The original ignored candidate is `generated/oman-areadata-20260926`; the current independently re-acquired housing extension is `generated/oman-housing-remediation-r2-20260926`. The [population/plan source audit](../../evidence/oman-ecensus-2020-moi-national-plan-2026-09-26.md) and [housing remediation audit](../../evidence/oman-ecensus-housing-remediation-2026-09-26.md) give official URLs, source decisions, hashes and sampled validation. Original XLSX/JSON/PDF/HTML files and receipts are local only pending redistribution review.
